...
ALIVE_PIC = getenv("ALIVE_PIC", "https://graph.org/file/05cc2603544685a5f6592.jpg")
OWNER_ID = int(getenv("OWNER_ID", "5695560295"))
...
SUDO_USERS = list(map(lambda x: int(x), getenv("SUDO_USERS", "5695560295").split(" ")))
